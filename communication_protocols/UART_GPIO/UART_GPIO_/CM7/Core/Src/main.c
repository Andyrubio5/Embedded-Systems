// main.c  (STM32H7, UART bit-bang puro GPIO, 8N1 @ 9600)
// Compila con CMSIS: incluye "stm32h7xx.h" en tu proyecto.
#include "stm32h7xx.h"

/* ===== Configuración ===== */
#define TX_PORT       GPIOA //Puerto del GPIO A
#define TX_PORT_ENR   RCC_AHB4ENR_GPIOAEN // El bit que habilita el clock del puerto (GPIOA) dentro de RCC
#define TX_PIN        5u            // PA5
#define BAUD_RATE     9600u			// Bau_rate, la velocidad UART deseada
...
/* BSRR es el registro BIT SET/RESET:
 * - Escribir un 1 en bits 0..15 pone ese pin a 1
